...
# def resnet18_ds_ref_blur(pretrained=False, filter_size=1, pool_only=True, **kwargs):
...
# def resnet34_ds_ref_blur(pretrained=False, filter_size=1, pool_only=True, **kwargs):
...
# def resnet50_ds_ref_blur(pretrained=False, filter_size=1, pool_only=True, **kwargs):
...
# def resnet101_ds_ref_blur(pretrained=False, filter_size=1, pool_only=True, **kwargs):
